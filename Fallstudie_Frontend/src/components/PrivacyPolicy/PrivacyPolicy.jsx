        ...
        <div className="privacy-policy-container">
            ...
            <p>
                <ul>
                    ...
                    <li><strong>Verarbeitung:</strong> Jeder mit oder ohne Hilfe automatisierter Verfahren ausgeführte Vorgang oder jede Vorgangsreihe im Zusammenhang mit personenbezogenen Daten.</li>
                    <li><strong>Verantwortlicher:</strong> Die natürliche oder juristische Person, Behörde, Einrichtung oder andere Stelle, die allein oder gemeinsam mit anderen über die Zwecke und Mittel der Verarbeitung von personenbezogenen Daten entscheidet.</li>
                </ul>
            </p>
            ...
            <p>
                <strong>5. Nutzung und Weitergabe personenbezogener Daten</strong>
            </p>
            <p>
                Nur in Ausnahmefällen werden personenbezogene Daten weitergegeben, beispielsweise an Dritte, wenn dies gesetzlich erlaubt ist oder die betroffene Person eingewilligt hat.
            </p>
            ...
            <p>
                Weitere Informationen zu diesen Rechten finden Sie in der Verordnung (EU) 2016/679.
            </p>
